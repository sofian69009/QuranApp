 ...
 * @ORM\Entity(repositoryClass="Sofian\Bundle\QuranAppBundle\Entity\QuranTextRepository")
 */
class QuranText // supl single quotes in column name if column name is sql reserved keyword (eg = index, count, ect)
{
     ...
     * Set sura
     *
     * @param \Sofian\Bundle\QuranAppBundle\Entity\Sura $sura
     * @return QuranText
     */
    public function setSura(\Sofian\Bundle\QuranAppBundle\Entity\Sura $sura = null)
    {
        $this->sura = $sura;
     ...
     * Get sura
     *
     * @return \Sofian\Bundle\QuranAppBundle\Entity\Sura 
     */

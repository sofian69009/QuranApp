...
namespace Sofian\Bundle\QuranAppBundle\Services\Json;

class QuranMetaData
{

private $suraMetaDatas = [// [start, ayas, order, rukus, name, tname, ename, type]
...
[6230, 6, 21, 1, 'الناس', "An-Naas", 'Mankind', 'Meccan'],];
     ...
     * @return array
     */
    public function getSuraMetaDatas()
    {
        return $this->suraMetaDatas;
    }
